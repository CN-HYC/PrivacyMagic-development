...
int main(int argc, char const *argv[])
{
    ...
    else if (argc > 1 && string(argv[1]) == "--socket")
    {
        ...
        if (argc > 2 && string(argv[2]) == "0")
        {
            ...
            SocketServer::Receiver<double> server(8080);
        ...
        else if (argc > 2 && string(argv[2]) == "1")
        {
            ...
            SocketClient::Sender<double> client("127.0.0.1", 8080);
    ...
    {
        cout << "Usage: " << argv[0] << " [--logo | --hashdemo]" << endl;
        cout << "  --logo      Print the logo" << endl;
        cout << "  --hash  Run the hash demo" << endl;
        cout << "  --socket    Run the socket demo (requires additional argument 0 or 1)" << endl;
